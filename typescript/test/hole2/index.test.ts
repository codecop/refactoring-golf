...
import TakeHomeCalculator, {Pair, Incalculable} from '../../src/hole2';

describe('Hole 2: Take Home Calculator should', () => {
    ...
    should.throws(
      () =>
        new TakeHomeCalculator(10).netAmount(
          new Pair<number, string>(4, 'GBP'),
          new Pair<number, string>(5, 'USD')
        ),
      Incalculable
    );
  });
